 ...
 *
 */
public class ScaSegmentizedTextDecorator extends ScaMetadataDecorator
{
	private static final String ATTR_METADATA_SEGMENT = "segment";
	...
	{
		return (item.getItem() instanceof SegmentizedTextModel);
	}

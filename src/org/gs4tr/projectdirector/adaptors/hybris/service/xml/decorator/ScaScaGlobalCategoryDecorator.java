 ...
 *
 */
public class ScaScaGlobalCategoryDecorator extends ScaMetadataDecorator
{
	...
	{
		return (item.getItem() instanceof ScaGlobalCategoryModel);
	}
	...
	{
		final ScaGlobalCategoryModel category = (ScaGlobalCategoryModel) localizableItem.getItem();

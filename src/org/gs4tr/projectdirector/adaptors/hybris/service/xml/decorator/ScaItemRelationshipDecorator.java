 ...
 * 
 */
public class ScaItemRelationshipDecorator extends ItemRelationshipDecorator
{
	...
	{
		// Decorate each attribute element with parentAttribute attribute
		decorateItemElement(localizableItem, element, document);
	}
